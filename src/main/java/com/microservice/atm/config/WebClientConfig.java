...
public class WebClientConfig {
	...
	public WebClient registerWebCounthR() {
		return WebClient.create("http://localhost:8090/apicounth/retire/dni");
	...
	public WebClient registerWebCurrentR() {
		return WebClient.create("http://localhost:8090/apicurrent/retire/dni");		
	}
	
	@Bean
	@Qualifier("CurrentD")
	public WebClient registerWebCounthD() {
		return WebClient.create("http://localhost:8090/apicounth/deposite/dni");	
	}
	
	@Bean
	@Qualifier("CurrentR")
	public WebClient registerWebCurrentD() {
		return WebClient.create("http://localhost:8090/apicurrent/deposite/dni");		
	}
}
